          ...
          <template v-if="advanced">
            <a-col :md="8" :sm="24">
              <a-form-item label="总价">
                <a-input v-model="queryParam.totalPrice" placeholder="总价"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item label="外部订单号">
                <a-input v-model="queryParam.outTradeNo" placeholder="外部订单号"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="总价">
                <a-input v-model="queryParam.payTotalPrice" placeholder="总价"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="会员id">
                <a-input v-model="queryParam.memberId" placeholder="会员id"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item label="会员名称">
                <a-input v-model="queryParam.memberName" placeholder="会员名称"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item label="openid">
                <a-input v-model="queryParam.openid" placeholder="openid"/>
              </a-form-item>
            </a-col>
          </template>
...
import { GetPage, UpdateById, Create, DeleteById } from '@/api/trade'
